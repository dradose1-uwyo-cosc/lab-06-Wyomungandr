...
ord_char_count = dict(sorted(char_count.items()))
for char, count in ord_char_count.items():
    print(f'{char}: {count}')
# Output which letter occurred the most 
# Output which letter occurred the least 
most_occ = max(char_count, key=char_count.get)
least_occ = min(char_count, key=char_count.get)
print(f"The letter that occurred the most is '{most_occ}' with {char_count[most_occ]} occurrences.")
print(f"The letter that occurred the least is '{least_occ}' with {char_count[least_occ]} occurrences.")
...
print(f"The letter that occurred the most is {most_occ}")
print("*"*75)
# Output which letter occurred the least 
print(f"The letter that occurred the most is {least_occ}")
print("*"*75)

# Output what the percentage of the string each character is, again in alphabetical
total_chars = len(random_string)
print("Percentage of each character in the string:")
for char, count in ord_char_count.items():
